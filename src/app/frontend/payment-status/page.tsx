...
export default function PaymentStatusPage() {
  ...
  const handleLoginRedirect = () => {
    ...
    if (typeof window !== "undefined") {
      sessionStorage.setItem("redirectAfterLogin", "/frontend/payment-status");
    }
  ...
  const handleViewReceipt = (order: Order, payment: Payment) => {
        ...
        <div className="bg-white rounded-lg shadow-lg p-8 max-w-md w-full mx-4">
          <div className="text-center">
            ...
            <p className="text-gray-600 mb-6">
              Anda harus login terlebih dahulu untuk melihat daftar pesanan Anda.
            </p>
    ...
    return (
      <div className="min-h-screen flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="mt-4 text-gray-600">Memuat daftar pesanan...</p>
        </div>
      </div>
    );
  }
    ...
    <div className="min-h-screen bg-gray-50">
      <div className="w-full px-4 py-8">
        ...
        <div className="mb-8">
          ...
          <p className="text-gray-600">Lihat semua pesanan dan status pembayaran Anda</p>
        </div>
        ...
        {orders.length === 0 ? (
          <div className="text-center py-12">
            ...
            <p className="text-gray-600 mb-6">Mulai berbelanja untuk melihat daftar pesanan Anda</p>
            <button
              onClick={() => router.push("/frontend/marketplace")}
        ...
        {/* Receipt Modal */}
        {showReceipt && selectedOrder && selectedPayment && (
